...
PATH_TO_VISUAL = {
    ...
    'SigLIP_SO': '/disk3/MER-2025/MER2025_Track23/models/siglip-so400m-patch14-384',
}
...
#######################
DATA_DIR = {
    'MER2025OV':        '/disk3/Datasets/zengyb/Datasets/MER2025_data/track1_3',
    'MERCaptionPlus':   '/disk3/Datasets/zengyb/Datasets/MER2025_data/track1_3',
    'OVMERD':           '/disk3/Datasets/zengyb/Datasets/MER2025_data/track1_3',
    'MSA':              '/disk3/Datasets/zengyb/Datasets/MER2025_data/track1_3',
}
PATH_TO_RAW_AUDIO = {
    ...
    'MSA':  os.path.join(DATA_DIR['MSA'], 'msa_audio'),
}
PATH_TO_RAW_VIDEO = {
    ...
    'MSA':  os.path.join(DATA_DIR['MSA'], 'msa_video'),
}
PATH_TO_RAW_FACE = {
    ...
    'MSA':  os.path.join(DATA_DIR['MSA'], 'msa_face'),
}
PATH_TO_TRANSCRIPTIONS = {
    ...
    'MSA':  os.path.join(DATA_DIR['MSA'], 'msa_subtitle_chieng.csv'),
}
PATH_TO_LABEL = {
    ...
    'MSA':  os.path.join(DATA_DIR['MSA'], 'xxx'),
}
