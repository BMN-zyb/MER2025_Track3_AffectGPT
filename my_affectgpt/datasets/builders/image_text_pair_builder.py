...
from my_affectgpt.datasets.datasets.msa_dataset import MSA_Dataset
...
@registry.register_builder("msa")
class MSA_Builder(BaseDatasetBuilder):
    train_dataset_cls = MSA_Dataset

    def build_datasets(self):
        logging.info("Building datasets MSA_Dataset")
        self.build_processors()
