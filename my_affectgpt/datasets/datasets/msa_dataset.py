...
class MSA_Dataset(BaseDataset):
    def __init__(self, vis_processor=None, txt_processor=None, img_processor=None,
        ...
        ################# 直接手动指定所有信息的存储路径 #################
        ov_path = os.path.join(config.DATA_DIR[self.dataset], 'track2_train_msa.csv')
        name2openset = {}
        ...
        description_path = os.path.join(config.DATA_DIR[self.dataset], 'track3_train_msa.csv')
        name2reason = {}
