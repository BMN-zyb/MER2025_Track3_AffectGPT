...
if __name__ == "__main__":
    ...
    # torchrun --nproc_per_node=2 train.py --cfg-path=train_configs/ovmerd_outputhybird_bestsetup_bestfusion_frame_lz.yaml
    # CUDA_VISIBLE_DEVICES=0 python -u train.py --cfg-path=train_configs/ovmerd_outputhybird_bestsetup_bestfusion_frame_lz.yaml
    # CUDA_VISIBLE_DEVICES=0 python -u train.py --cfg-path=train_configs/msa_outputhybird_bestsetup_bestfusion_frame_lz.yaml
